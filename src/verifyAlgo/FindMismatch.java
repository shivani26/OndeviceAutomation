	...
	public static void main(String[] args) throws Exception{
		...
		for(int i = 0; i < songsMetaData.length() && i < jsons.length; i++){
			if(!jsons[i].trim().equalsIgnoreCase("No Match Found")){
				...
				//String offlinePublishedYear = getCleanedString(get(json,""));
			    ...
			    //if(comp == false && !(compare1 == 0 || compare2 == 0 && offlineAlbum != onlineAlbum || diff > 3))
			    {
			    	...
			    	//System.out.println("Content Found :: " + (i+1) + ",  OndeviceContentId :: " + onlineId + ", OnlineContentId :: " + offlineId + ", OndeviceTitle :: " + onlineTitle + ", OnlineTitle ::" + offlineTitle);
			    	
			    	
			    	System.out.println("Content not Found :: "+ (i+1) + ", OndeviceContentId :: " + onlineId + ", OnlineContentId :: "  + offlineId + ", OndeviceAlbum :: "  + onlineAlbum + ", OnlineAlbum :: " + offlineAlbum + ",  OndeviceTitle :: "  + onlineTitle + ", OnlineTitle :: " + offlineTitle + ", OndeviceDuration ::" + onlineDuration + ", OnlineDuration ::" + offlineDuration );
			    	continue;
				} 
				
				if(compare1 == 0 || compare2 == 0  || diff > 3){
					
					System.out.println("Album/Title Mismatch :: "+ (i+1) + ", OD id ::" + onlineId + ", Ol ID ::"  + offlineId + ", OndeviceAlbum :: "  + onlineAlbum + ", OnlineAlbum :: " + offlineAlbum + ",  OndeviceTitle :: "  + onlineTitle + ", OnlineTitle :: " + offlineTitle + ", OndeviceDuration ::" + onlineDuration + ", OnlineDuration ::" + offlineDuration );
				}

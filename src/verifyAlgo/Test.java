...
public class Test {
	public static void main(String[] args) throws Exception{
		...
		JSONArray songsMetaData = convertToJSONArray(System.getProperty("user.dir") + "/content/songsMetaData.json");
		String matchResult = readAll(new FileReader(System.getProperty("user.dir") + "/content/songsResult.json"));

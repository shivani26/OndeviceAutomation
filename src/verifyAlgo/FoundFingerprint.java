...
public class FoundFingerprint {
	public static void main(String[] args) throws Exception{
		...
		File file = new File("FPfound.txt"); //Your file
		...
		for(int i = 0; i < songsMetaData.length() && i < jsons.length; i++){
			if(!jsons[i].trim().equalsIgnoreCase("No Match Found")){
			    ...
			    {	
			    	System.out.println("Content Found :: "+ (i+1) + ",  OndeviceTitle :: "  + onlineTitle + ", OnlineTitle :: " + offlineTitle + ", OndeviceAlbum :: " + offlineAlbum + ", OnlineAlbum :: " + onlineAlbum);
					continue; 
				} 
				}	
			}
